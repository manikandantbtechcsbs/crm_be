...
app.use(cors());
app.use(express.json()); // ADDED — required for req.body
...
const dbConfig = {
  ...
  password: process.env.MYSQLPASSWORD,// // FIXED
  database: process.env.MYSQLDATABASE,// // FIXED
  port: process.env.MYSQLPORT         // // FIXED
};
